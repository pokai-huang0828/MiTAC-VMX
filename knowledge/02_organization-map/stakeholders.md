...
| 會議 | 時段 | 性質 | 重點 |
|------|------|------|------|
| **Azuga AI weekly** | 每週三 15:30 – 17:00(實際 5/13 開的是 Tue 下午)| 客戶端 | 🆕 **5/13 最新場揭露 6/2 五大 deliverable + Camera Auto-Height + Eye Stable Rate + HAWK-401/482 stalled**(Mitac × Azuga + Webfleet 聯合 weekly,8 議題 + 11 action items)→ 詳見 [`meetings/2026-05-13_azuga-ai-weekly.md`](../../meetings/2026-05-13_azuga-ai-weekly.md) · 過去:5/6 揭露 Lens Cover 標準版規格 |
| **內部 AI weekly** | 每週二、四 10:00 – 12:00 | 內部 | 🆕 **5/11 最新場揭露**:Model 11P/11L/26/V14 對應 + **6/2 Fix Version 五大死線**(2026-05-14 從三大擴大,詳見 5/13 Azuga AI Weekly)+ 5/15 Beta 前置 → 詳細在 [`meetings/ai-weekly-internal-roundup.md`](../../meetings/ai-weekly-internal-roundup.md)(series 檔)|
