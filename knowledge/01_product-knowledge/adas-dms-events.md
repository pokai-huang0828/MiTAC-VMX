...
- **Speed Sign**(in development) — Roadmap 列 Advanced 2027,KB 對外目前是 dev
...
|------|--------------|-----------------------------|
| **Yawning(Fatigue 子)** | Basic(2025) | ⚠️ **還沒給客戶 / 內部測試中 / 效果不如預期 / Fatigue config 下要加獨立開關** |
| **Smoking** | Basic(2025) | ⚠️ KB 沒寫 / Sheet 隱藏 / 4 個 Jira ticket open(VMX-6670 / 7324 / 6380 / 6920) |
