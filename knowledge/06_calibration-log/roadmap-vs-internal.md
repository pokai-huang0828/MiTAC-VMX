...
| Fatigue config | 目前只有眼睛偵測,**Yawning 開關待加 → 對應 [VMX-7432](https://jira.navman.co.nz/jira/browse/VMX-7432)**(Lucy 5/6 開)|
| Jira tickets | **[VMX-7432](https://jira.navman.co.nz/jira/browse/VMX-7432)**(Yawning UI toggle, Lucy assignee)⚠️ [VMX-7309](https://jira.navman.co.nz/jira/browse/VMX-7309) 是 Eye threshold 不是 Yawning |
...
| Jira | 4 個 open ticket([VMX-6670](https://jira.navman.co.nz/jira/browse/VMX-6670) / 7324 / 6380 / 6920) |
...
| memory | 還沒上線、測試中 |
| Jira | [VMX-6353](https://jira.navman.co.nz/jira/browse/VMX-6353) / [VMX-6925](https://jira.navman.co.nz/jira/browse/VMX-6925)(open) |
| **對客戶口徑** | ❌ **不對任何客戶承諾** |
...
| AI Sheet | [HAWK-562](https://jira.navman.co.nz/jira/browse/HAWK-562) 已開,Jimmy 在動 |
...
| Stage 2 Edge + Server AI | 已上 | ✅ **Server-side LDWS([VMX-6722](https://jira.navman.co.nz/jira/browse/VMX-6722))Q1 已 deploy prod**(jimmy 3/11 確認)。⚠️ Device-side YOLO Lane Detection 改善 5/7 決議 Pending 暫緩(資源緊繃,新 ticket 編號待釐清)| 「Server-side LDWS 已部屬,device 端持續改善中」 |
