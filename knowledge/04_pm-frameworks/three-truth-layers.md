...
|------|----|----|---------|-----------|
| Yawning | 沒寫 | 內部測試,效果不如預期 / **5/7:加灰階模型,考慮改辨識整張臉 / UI = VMX-7432(Lucy)** | Basic 2025 已 ship | Roadmap planned, 內部測試中 |
...
| Eating/Drinking | 沒寫 | HAWK-562 / **5/7:BMS 客訴 17x 量級(ID 6652),6/15 前 7000+ 案例緊急重訓** | Advanced 2027 | 對外講 2027,**對 BMS 講 6/15 內部緊急重訓** |
