...
對 Brian 提 process improvement 應從「transition 紀律」切入,不是「label 紀律」。詳見 [knowledge/06_calibration-log/ai-tab-jira-alignment-2026-05-07.md](../knowledge/06_calibration-log/ai-tab-jira-alignment-2026-05-07.md) H 段 + [meetings/ai-weekly-internal-roundup.md](ai-weekly-internal-roundup.md)。
